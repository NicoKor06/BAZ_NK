...
VALUES ($1, $2, $3) RETURNING blog_id, headline, body, created_at, updated_at, user_id
`
...
SELECT blog_id, headline, body, created_at, updated_at, user_id
FROM blogs
...
SET headline   = COALESCE($2, headline), -- Falls ein neuer Wert vorhanden ist, ersetze ihn. Ansonsten behalte den Alten.
    ...
    updated_at = NOW()
WHERE blog_id = $1
  AND user_id = $4 RETURNING blog_id, headline, body, created_at, updated_at, user_id
`
